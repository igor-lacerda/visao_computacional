...
Este projeto é uma ferramenta para manipulação de imagens ou vídeos que reúne diversas funcionalidades que aprendi ao longo do quarto ano da faculdade de eletrônica. Ele integra detecção de objetos (YOLOv8), detecção de bordas (Canny) e concatenação de vídeos e outras funções mais diretas.
